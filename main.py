...
url = 'http://raw.githubusercontent.com/MMVG02/telegram-configs-collector/refs/heads/main/telegram%20channels.json'
filename = 'telegram channels.json'
wget.download(url, filename)

tg_username_list.update(array_usernames)
telegram_proxies_channel = json_load('./telegram channel.json')
tg_username_list.update(telegram_proxies_channel)
os.remove('./telegram channel.json')
